<template>
  <div id="grayscale-page">
    <div class="q-pa-md">
      <div class="row">
        <div class="text-h5">Hasil Konversi citra asli menjadi citra grayscale</div>
      </div>
...
const { grayscaleImageName } = useImageStore();
const imageUrl = ref('');
...
const getImage = async () => {
  return await api.get(`image/${grayscaleImageName}`);
...
const handleSave = async () => {
  ...
  link.href = blobUrl;
  link.download = 'grayscale_image.jpg';
