<template>
  <div id="negative-page">
    <div class="q-pa-md">
      <div class="row">
        <div class="text-h5">Hasil Konversi citra asli menjadi citra negatif</div>
      </div>
...
const { negativeImageName } = useImageStore();
const imageUrl = ref('');
...
const getImage = async () => {
  return await api.get(`image/${negativeImageName}`);
